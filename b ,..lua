...
local videodata = readfile('videodatae.txt') -- 0-1 tonescale
local data = {}
...
fire = function(d)
    ...
    game:GetService("Players").LocalPlayer:WaitForChild("RPStatus"):WaitForChild("Cleared"):FireServer()
    game:GetService("ReplicatedStorage"):WaitForChild("MessageEvent"):FireServer(d)
    --print(d, #d)
end
