...
local slave = game.ReplicatedStorage.filterws--boombox:FindFirstChildOfClass('RemoteEvent',true)
...
for _,frame in ipairs(data) do
	...
	--slave:FireServer(parsed)
    task.spawn(slave.InvokeServer,slave,parsed)
